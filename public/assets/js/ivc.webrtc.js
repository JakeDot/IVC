...
async function encryptMetadataE2EE(metadataObj, channelId, channelPasskey = '') {
    try {
        ...
        throw new Error('E2EE encryption failed. Unencrypted fallback is strictly prohibited by security policy.');
    }
}
...
async function decryptMetadataE2EE(encryptedBase64, channelId, channelPasskey = '') {
    try {
        ...
        if (combined.length <= 12) {
            throw new Error('E2EE decryption failed: invalid ciphertext length.');
        }
        ...
        throw new Error('E2EE decryption failed. Unencrypted fallback is strictly prohibited by security policy.');
    }
}
