 ...
 */
class ServServ extends IrcObject
{
    use NoModeTrait;
    ...
    /**
     * Check if a given nick holds IRCop privileges.
     *
     * @param string $nick
     * @return bool
     * @todo Wire to an actual operator list / DB when implemented.
     */
    public static function isOper(string $nick): bool
    {
        return false;
    }
    ...
    public static function dispatchForeignCommand(string $senderNick, string $serviceName, string $commandText): array
    {
        ...
        // In a real HTTP / webhook bridge this would call $fs['api_endpoint']
