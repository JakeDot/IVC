...
class Channel
{
    ...
    {
        $channel = \cx\ivc\IRC\ChanServ::normalizeChannelName($channel);
        return \cx\ivc\Database\ChannelUserRepository::hasVoice($channel, $nickname);
    }
    ...
    {
        $channel = \cx\ivc\IRC\ChanServ::normalizeChannelName($channel);
        return \cx\ivc\Database\ChannelUserRepository::isAdmin($channel, $nickname);
    }

    public static function isNetAdmin(string $channel, string $nickname): bool
    {
        $channel = \cx\ivc\IRC\ChanServ::normalizeChannelName($channel);
        return \cx\ivc\Database\ChannelUserRepository::isNetAdmin($channel, $nickname);
    }
