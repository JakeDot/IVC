...
// Test 22: WhatsApp Service Bridge Logic
echo "\n22. Testing WhatsApp Service Connector...\n";
require_once __DIR__ . '/../src/Services/WhatsAppService.php';
use cx\ivc\Services\WhatsAppService;

$ident1 = WhatsAppService::identifyUser('johndoe', '+1234567890');
assertTest($ident1 === 'johndoe@$whatsapp.net', 'WhatsAppService identified user with username correctly');

$ident2 = WhatsAppService::identifyUser(null, '+0987654321');
assertTest($ident2 === '+0987654321@$whatsapp.net', 'WhatsAppService identified user with phone number correctly');
...
$webhookRes = WhatsAppService::handleWebhook($webhookPayload);
assertTest($webhookRes['success'] === true && $webhookRes['ident'] === 'janedoe@$whatsapp.net', 'WhatsAppService handled webhook successfully and extracted ident');
